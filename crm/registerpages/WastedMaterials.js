...
const heightpercent =  windowHeight/100
const quater = windowWidth/4
const answer = quater/heightpercent + '%'



export default function WastedMatierals({navigation}) {
    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={styles.logo}>
        ...
        <TextInput
          ...
          placeholder="Использованный объем"
          iconType="user"
          autoCapitalize="none"
          autoCorrect={false} 
          style={styles.input}
