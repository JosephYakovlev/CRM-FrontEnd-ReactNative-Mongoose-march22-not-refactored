...
export default function YourBrigadesTechnicsPage({navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{width:'100%', flexDirection: 'row', marginBottom: 10, minHeight: 70}}>
                <TouchableOpacity onPress={routeYourBrigadesPeoplePage} style={{...styles.categoryBarPart,backgroundColor: 'lightgrey', width: '50%'}}>
                ...
                <TouchableOpacity onPress= {routeYourBrigadesTechnicsPage} style={{...styles.categoryBarPart,backgroundColor: 'lightgreen', width: '50%', borderLeftWidth: 0}}>
                    <Text style={{fontSize: 20}}>
                        Техника
                    </Text>
                </TouchableOpacity>
