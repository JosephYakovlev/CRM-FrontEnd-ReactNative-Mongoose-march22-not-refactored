...
export default function ContractObjectsPage({navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{width:'100%', flexDirection: 'row', marginBottom: 10, minHeight: 70}}>
                <TouchableOpacity onPress={routeContractObjectsPage} style={{...styles.categoryBarPart,backgroundColor: 'lightgreen', width: '50%'}}>
                    <Text style={{fontSize: 20}}>
                        Подрядные
                    </Text>
            ...
            <View style={{ alignSelf: 'center', marginBottom: 10, alignItems: 'center'}}>
                ...
                <Text style={{fontSize: 20, fontWeight: '500', color: 'blue'}}>
                    не являетесь подрядчиком 
                </Text>

                <Text style={{fontSize: 20, fontWeight: '500'}}>
                    на каких-либо объектах
                </Text>
            </View>
