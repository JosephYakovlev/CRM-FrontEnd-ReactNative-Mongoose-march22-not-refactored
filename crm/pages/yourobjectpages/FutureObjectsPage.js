...
export default function FutureObjectsPage({navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{width:'100%', flexDirection: 'row', marginBottom: 10, minHeight: 70}}>
                ...
                <TouchableOpacity onPress= {routeFutureObjectsPage} style={{...styles.categoryBarPart,backgroundColor: 'lightgreen', width: '50%', borderLeftWidth: 0}}>
                    <Text style={{fontSize: 20}}>
                        Будущие
                    </Text>
                </TouchableOpacity>
