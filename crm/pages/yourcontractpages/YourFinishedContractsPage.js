...
export default function YourFinishedContractsPage({navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{width:'100%',  marginBottom: 10, minHeight: 70, alignItems: 'center'}}>
                ...
                <TouchableOpacity onPress= {routeYourFinishedContractsPage} style={{...styles.categoryBarPart,minHeight: 70,backgroundColor: 'lightgreen', width: '80%', borderTopWidth: 0, borderLeftWidth: 1}}>
                    <Text style={{fontSize: 20,fontWeight: '500'}}>
                        Завершенные
                    </Text>
                </TouchableOpacity>
