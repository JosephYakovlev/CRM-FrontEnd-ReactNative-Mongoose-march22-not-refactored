...
export const FinConCard = (caseD) => {
    ...
    const routeOpenedCase = () =>{
        navigation.navigate('ClosedCasePage',ticket)
    ...
    return ( 
        <View style={{...styles.ticketContainer, backgroundColor: '#05C6AB'}}>
            <TouchableOpacity onPress={routeOpenedCase} style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around'}}>
                ...
                <View style={styles.leftTicketCont}> 
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <Text style={{fontSize: 17, fontWeight: '700', color: 'white', marginLeft: 5}}>
                            Сделка завершена
                        </Text> 
                    </View>
                </View>
