...
export const ClosedCasePage = (data) => {
  ...
  const headerHeight = getStatusBarHeight()
    ...
    const indexRCaseData = currentUser.finishedContracts.findIndex(i => i._id === CsId)
    
    const runningCaseData = (currentUser.finishedContracts[indexRCaseData] ? currentUser.finishedContracts[indexRCaseData] : data.route.params)
    ...
    <Modal 
      ...
      >
        <TouchableOpacity style={styles.modalOne} onPress = {hideDoneWorkOne}>
          ...
          <TouchableOpacity style={styles.cam} onPress={alertclosedcase}>
          ...
          <TouchableOpacity style={styles.gal} onPress={alertclosedcase}>
      ...
      >
        <TouchableOpacity style={styles.modalOne} onPress = {hideCloseCase}>
          ...
          <TouchableOpacity onPress={alertclosedcase} style={styles.deni}>
...
<Modal 
      ...
      >
        <TouchableOpacity style={styles.modalOne} onPress = {hideDoneWork}>
          ...
          <TouchableOpacity onPress={alertclosedcase} style={{...styles.deni, backgroundColor: 'lightgreen'}}>
          ...
          <>
            ...
            {currentDoneWork.paid >= currentDoneWork.price ? 
              <View style={{...styles.deni, backgroundColor: 'green'}}>
                ...
                <>
                <TouchableOpacity onPress={alertclosedcase}  style={{...styles.deni, backgroundColor: 'green'}}>
          ...
          <View style={styles.modalInnerDialog}>
            ...
            {showEnd && (
                ...
                <View style={styles.caseTitle}>
                    <Text style={{fontSize: 24, fontWeight: 'bold'}}>Завершенный контракт</Text>
                </View>
                ...
                <View style={styles.caseMembers}>
                    <View style={styles.memberCont}>
                        ...
                        {votedEndContractor == true &&  <TouchableOpacity onPress={alertclosedcase} style={{position: 'absolute', height: 108, width: 108, top: 21, left: 6, backgroundColor: 'green', alignItems: 'center', justifyContent: 'center', borderRadius: 54, borderWidth: 2, borderColor: 'yellow'}}>
                        ...
                        {votedEndContractor == false && currentUser._id == runningCaseData?.caseContractor && <TouchableOpacity onPress={alertclosedcase} style={{position: 'absolute', height: 50, width: 80, bottom: -20, left: 3, backgroundColor: 'red', alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 2, borderColor: 'black'}}>
                    ...
                    <View style={styles.memberCont}>
                        ...
                        {votedEndOwner == true && <TouchableOpacity onPress={alertclosedcase} style={{position: 'absolute', height: 108, width: 108, top: 21, right: 3, backgroundColor: 'green', alignItems: 'center', justifyContent: 'center', borderRadius: 54, borderWidth: 2, borderColor: 'yellow'}}>
                            <Text style={{ color: 'white', fontSize: 14, fontWeight: 'bold'}}>
                                Предлагает
                            </Text>
                            <Text style={{ color: 'white', fontSize: 19, fontWeight: 'bold'}}>
                        ...
                        {votedEndOwner == false && currentUser._id == runningCaseData?.caseOwner && 
                          <TouchableOpacity onPress={alertclosedcase} 
                ...
                <TouchableOpacity onPress={() => {currentUser._id == runningCaseData.caseOwner ?  (setCurrentDoneWork({...workUnit, indx: index +1}), showDoneWork()) : (setDeletingDoneWork({...workUnit,indx: index+1}), showDeleteDoneWork()) }}  key = {workUnit._id} style={{width:'98%', height: 100,flexDirection: 'row', alignItems: 'center', marginTop: 17, borderWidth:1, borderStyle:'dashed', alignSelf: 'center', marginBottom: index+1 === workDay.workDone.length ? 10 : 0}}>
                ...
                {currentUser._id !== runningCaseData.caseOwner && <View style={{width: '100%', marginBottom: 10, marginTop: 10, paddingVertical: 10,}}>
                    ...
                    <TouchableOpacity onPress={alertclosedcase} style={{width: '70%',  height: 50, alignItems: 'center', justifyContent:'center', flexDirection: 'row', backgroundColor: 'lightgrey', borderRadius: 10, borderWidth: 1, alignSelf: 'center'}}>
