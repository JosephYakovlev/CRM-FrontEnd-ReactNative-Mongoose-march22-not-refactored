...
export default function MainAddReg({navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={routeRegisterTicketPage} style={{justifyContent: 'center', alignItems: 'center'}}>
                <ImageBackground source ={require('../../assets/crm/logo.png')} style={{
                    width: 370,
                    height: 520,
                    marginTop: 15,
                    alignItems: 'center',
                    ...
                    opacity: 0.9
                        ...
                        <Text style={{fontSize: 29, fontWeight: 'bold', marginBottom: 239}}>
                            Решить задачу
                        </Text>
                </ImageBackground>
            </TouchableOpacity>
